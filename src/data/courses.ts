...
const seedCourses: GolfCourse[] = [
  ...
  // ── 추가 명문·인기 코스 ──────────────────────────────────
  {
    ...
    features: ["27홀", "회원제", "잭 니클라우스 설계", "프리미엄 회원제"],
    nearby: ["아침고요수목원", "쁘띠프랑스", "자라섬"],
  },
  {
    slug: "lakewood-cc",
    name: "레이크우드 컨트리클럽",
    ...
    openedYear: 1972,
    description:
      "1972년 문을 연 수도권 1세대 명문으로, 오랜 세월 다져진 수림과 자연 지형이 코스의 격을 만듭니다. 36홀 전 코스와 클럽하우스를 수년에 걸쳐 리뉴얼해 전통과 현대 시설을 함께 갖췄습니다. 서울 북부에서 접근이 빨라 도심 근교 라운드로 꾸준히 사랑받습니다.",
    features: ["36홀", "회원제", "수도권 1세대", "리뉴얼 코스"],
    nearby: ["장흥유원지", "송추계곡", "일영"],
  },
  {
    slug: "namchon-cc",
    name: "남촌 컨트리클럽",
    ...
    holes: 18,
    type: "회원제",
    greenFeeWeekday: 300000,
    greenFeeWeekend: 400000,
    openedYear: 2008,
    description:
      "GS그룹 계열이 운영하는 최상위 회원제 코스로, 카일 필립스가 리뉴얼 설계에 참여해 전략성과 미감을 끌어올렸습니다. 곤지암 산자락에 자리해 사계절 경관이 뚜렷하며, 회원권 시세가 국내 최고 수준으로 형성될 만큼 희소성이 높습니다.",
    features: ["18홀", "회원제", "카일 필립스 설계", "최상위 프라이빗"],
    nearby: ["곤지암리조트", "화담숲", "곤지암 소머리국밥"],
  },
  {
    slug: "yangji-pine-gc",
    name: "양지파인리조트 골프클럽",
    ...
    openedYear: 1970,
    description:
      "1970년 개장한 산악형 27홀 대중제 코스로, 독조산 기슭의 고저차를 그대로 살려 호쾌한 라운드를 즐길 수 있습니다. 콘도와 스키장을 갖춘 종합 리조트 안에 있어 가족 단위 방문객이 많고, 영동고속도로 양지 나들목에서 가까워 접근이 수월합니다.",
    features: ["27홀", "대중제", "산악형 코스", "리조트 연계"],
    nearby: ["에버랜드", "한국민속촌", "와우정사"],
  },
  {
    ...
    features: ["36홀", "회원제", "대형 연습장", "수도권 남부"],
    nearby: ["에버랜드", "기흥호수공원", "한국민속촌"],
  },
  {
    slug: "ferrum-club",
    name: "페럼클럽",
    ...
    features: ["18홀", "대중제", "다이 패밀리 설계", "안도 다다오 클럽하우스"],
    nearby: ["여주 신륵사", "명성황후 생가", "여주 프리미엄 아울렛"],
  },
  {
    ...
    openedYear: 1999,
    description:
      "삼성 베네스트 계열의 36홀 코스로, 임상하가 설계한 원그린 시스템과 도전적인 레이아웃이 특징입니다. 회원제 코스와 퍼블릭 코스를 함께 운영해 다양한 수요를 아우릅니다. 베네스트 특유의 잔디·벙커 관리가 라운드의 완성도를 높입니다.",
    features: ["36홀", "회원제", "임상하 설계", "베네스트 관리"],
    nearby: ["안성팜랜드", "안성맞춤랜드", "안성 국밥거리"],
  },
  {
    slug: "sky-valley-cc",
    name: "스카이밸리 컨트리클럽",
    ...
    openedYear: 1998,
    description:
      "회원제와 대중제 18홀씩 36홀을 나눠 운영하는 대형 코스로, 69만 평 부지에 네 개 코스를 펼쳐 놓았습니다. 산과 호수를 끼고 설계해 홀마다 경관이 달라지며, 대중제 코스 덕분에 비회원도 부담 없이 찾을 수 있습니다. 여주 나들목에서 가까워 수도권 동부 접근성이 좋습니다.",
    features: ["36홀", "대중제 운영", "산·호수 경관", "수도권 동부"],
    nearby: ["여주 신륵사", "명성황후 생가", "여주 프리미엄 아울렛"],
  },
  {
    slug: "360-degree-cc",
    ...
    openedYear: 2011,
    description:
      "사방으로 펼쳐지는 산세를 그대로 끌어안아 '360도'라는 이름을 붙인 18홀 대중제 코스입니다. 고저차와 굴곡이 분명해 같은 거리라도 클럽 선택이 까다롭고, 그만큼 공략하는 재미가 큽니다. 자연 지형을 거스르지 않은 설계가 라운드 내내 경관을 선사합니다.",
    features: ["18홀", "대중제", "산악형 코스", "경관 설계"],
    nearby: ["여주 신륵사", "강천섬", "여주 프리미엄 아울렛"],
  },
  {
    ...
    openedYear: 2010,
    description:
      "잭 니클라우스가 설계한 해안 링크스 스타일의 18홀 회원제 코스로, 송도 신도시 안에 자리해 도심과 바다 풍경이 어우러집니다. 2015년 아시아 최초로 프레지던츠컵을 개최하며 세계 골프 무대에 이름을 알렸습니다. 바람의 영향이 큰 링크스 특성상 거리 계산이 까다롭습니다.",
    features: ["18홀", "회원제", "프레지던츠컵 개최", "해안 링크스"],
    nearby: ["송도 센트럴파크", "트리플스트리트", "인천대교"],
  },
  {
    slug: "sonofelice-cc",
    name: "소노펠리체 컨트리클럽",
    ...
    openedYear: 2009,
    description:
      "비발디파크·소노벨 리조트와 연결된 36홀 코스로, 이스트와 웨스트 두 코스가 각기 다른 공략 묘미를 줍니다. 스키장과 오션월드를 함께 갖춘 단지 안에 있어 사계절 휴양형 라운드에 어울립니다. 서울에서 한 시간대로 닿는 접근성도 강점입니다.",
    features: ["36홀", "리조트형", "이스트·웨스트 코스", "사계절 휴양"],
    nearby: ["비발디파크", "오션월드", "팔봉산"],
  },
  {
    slug: "gaya-cc",
    name: "가야 컨트리클럽",
    ...
    openedYear: 1988,
    description:
      "여섯 개 코스 54홀을 갖춘 영남권 매머드급 골프장으로, 김해 시내에서 가까워 접근성과 규모를 모두 잡았습니다. KLPGA 대회가 열리는 코스를 포함해 난이도와 관리 수준이 고르게 높습니다. 코스 선택의 폭이 넓어 실력과 취향에 맞춰 라운드를 짤 수 있습니다.",
    features: ["54홀", "회원제", "KLPGA 개최", "6개 코스"],
    nearby: ["가야테마파크", "수로왕릉", "봉리단길"],
  },
  {
    ...
    openedYear: 1984,
    description:
      "30년 넘게 영남 골퍼들과 함께해 온 36홀 회원제 코스입니다. 호쾌한 남코스와 정교함을 요구하는 북코스가 뚜렷이 대비돼 같은 골프장에서 다른 결의 라운드를 경험할 수 있습니다. 통도사와 가까워 라운드와 사찰 여행을 함께 묶기 좋습니다.",
    features: ["36홀", "회원제", "남·북 코스 대비", "야간 라운드"],
    nearby: ["통도사", "통도환타지아", "에덴밸리"],
  },
  {
    slug: "cheonryong-cc",
    name: "천룡 컨트리클럽",
    ...
    openedYear: 1995,
    description:
      "진천 산지에 자리한 27홀 회원제 코스로, 청룡·흑룡·황룡 세 개 코스에 퍼블릭 9홀을 더해 구성을 갖췄습니다. 소수 정예 회원 운영으로 한적한 라운드가 가능하며, 산세를 살린 코스가 계절마다 다른 표정을 보여줍니다. 중부고속도로와 가까워 충청·수도권 양쪽에서 닿기 좋습니다.",
    features: ["27홀", "회원제", "소수 정예", "산지형 코스"],
    nearby: ["진천 농다리", "보탑사", "초평호"],
  },
];
